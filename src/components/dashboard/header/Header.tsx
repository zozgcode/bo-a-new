...
export default function Header({ handleLogout, user }: any) {
  ...
  return (
    <div className="w-full min-h-[30px] relative flex items-center justify-between bg-white p-[20px] py-[15px]">
      ...
      <div className="relative">
        ...
        {open && (
          <div className="absolute z-50 shadow bg-white border py-2 rounded-md right-0 flex flex-col justify-center gap-[5px]">
